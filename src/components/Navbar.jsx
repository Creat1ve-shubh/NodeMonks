...
export default function Navbar() {
    return (
        <div className="w-screen max-sm:h-fit max-sm:py-5 h-20 z-2 bg-transparent flex max-sm:flex-col max-sm:gap-4 justify-between items-center px-8 backdrop-blur-sm fixed top-0 left-0">
            <div>
                <Link href={"/"} className={`${abril_fatface.className} md:underline decoration-wavy decoration-amber-500 text-3xl `} >NodeMonks</Link>
            </div>

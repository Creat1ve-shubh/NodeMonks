            ...
            <div className="mx-auto max-w-2xl mt-10 px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
                    ...
                    <div className="relative lg:row-span-2 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl  overflow-hidden">
                        <div className="absolute inset-px rounded-lg bg-rose-500 opacity-80 lg:rounded-l-4xl"></div>
                    ...
                    <div className="relative max-lg:row-start-1 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl   overflow-hidden">
                        <div className="absolute inset-px rounded-lg bg-orange-600 max-lg:rounded-t-4xl"></div>
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                                <p className="mt-2 text-2xl font-medium tracking-tight text-gray-950 max-lg:text-center">Performance</p>
                                <p className="mt-2 max-w-lg text-lg text-gray-600 max-lg:text-center">
                    ...
                    <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl   overflow-hidden">
                        <div className="absolute inset-px rounded-lg bg-amber-500"></div>
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
                            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                                <p className="mt-2 text-2xl font-medium tracking-tight text-gray-950 max-lg:text-center">Security</p>
                                <p className="mt-2 max-w-lg text-lg text-gray-600 max-lg:text-center">
                    ...
                    {/* Card 4 */}
                    <div className="relative lg:row-span-2 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl   overflow-hidden">
                        <div className="absolute inset-px rounded-lg bg-amber-400 max-lg:rounded-b-4xl lg:rounded-r-4xl"></div>
                        <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                            <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                                <p className="mt-2 text-2xl font-medium tracking-tight text-gray-950 max-lg:text-center">Powerful APIs</p>
                                <p className="mt-2 max-w-lg text-lg text-gray-600 max-lg:text-center">
